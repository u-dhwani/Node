...
const users_2 = require("../validations/users");
...
class AuthController {
    signup(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validationResult = (0, users_2.validateSignup)(req.body);
                ...
                const existingUser = yield users_1.default.getUserByEmail(email);
                if (existingUser) {
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validationResult = (0, users_2.validateLogin)(req.body);
                if (validationResult.error) {
...
class UserController {
    ...
    deleteByEmail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validationResult = (0, users_2.validateDeleteByEmailSchema)(req.body);
    ...
    updateAddressOfUserByEmail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validationResult = (0, users_2.validateUpdateProfile)(req.body);
